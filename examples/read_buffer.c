...
int main()
{
    ...
    uint8_t crc_sum = calculate_checksum(rx_buff[2], rx_buff[3], rx_buff[4], (uint8_t[PARAM_LEN]) {rx_buff[PARAM_LEN+1], rx_buff[PARAM_LEN+2], rx_buff[PARAM_LEN+3], rx_buff[PARAM_LEN+4]});
